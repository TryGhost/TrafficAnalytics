...
describe('Fastify App (HMAC Log Only)', () => {
    ...
    beforeAll(async () => {
        ...
        process.env.HMAC_VALIDATION_LOG_ONLY = 'true';
    ...
    afterAll(async () => {
        ...
        delete process.env.HMAC_VALIDATION_LOG_ONLY;
    ...
    describe('POST /api/v1/page_hit', function () {
        ...
        it('should accept unsigned requests', async function () {
            await request(proxyServer)
                .post(path)
